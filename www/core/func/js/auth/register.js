		...
		if ($("#rSubmit").is(":disabled") == false) {
			...
			$.ajax({
				...
				success: function(data) {
					...
					}else if (data == "no-outlook") {
						$("#rStatus").html("<div class=\"alert alert-danger\">All outgoing traffic to outlook, yahoo, and aol are currently disabled due to their use of Spamhaus.</div>");
