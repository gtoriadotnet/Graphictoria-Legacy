<?php
	class user {
		public static function filter($string) {
			...
			$string = str_ireplace("RHODUM", "******", $string);
			$string = str_ireplace("MERCURY", "*******", $string);
			$string = str_ireplace("banland.xyz", "***********", $string);
			$string = str_ireplace("POLYGON", "*******", $string);
			$string = str_ireplace("PIZZABOXER", "**************", $string);
			$string = str_ireplace("TASKMANAGER", "***********", $string);
			$string = str_ireplace("CALVYY", "******", $string);
			$string = str_ireplace("CALVY", "*****", $string);
			$string = str_ireplace("TADAH", "*****", $string);
			$string = str_ireplace("ALPHALAND", "*********", $string);
			$string = str_ireplace("FINALB", "******", $string);
			return $string;
		}
	}
?>