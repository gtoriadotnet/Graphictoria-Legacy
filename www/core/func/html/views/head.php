...
<link type="text/css" rel="stylesheet" href="/core/html/css/global.css?v=8"/>
...
<script>
  ...
  ga('create', 'UA-197670272-1', 'auto');
  ga('send', 'pageview');
</script>
<?php
	if ($GLOBALS['loggedIn'] && $GLOBALS['userTable']['themeChoice'] == 1) echo '<link type="text/css" rel="stylesheet" href="/core/html/css/blackstyle.css?v=13"/>';
	if ($GLOBALS['loggedIn'] && $GLOBALS['userTable']['themeChoice'] == 0) echo '<link type="text/css" rel="stylesheet" href="/core/html/css/style.css?v=28"/>';
