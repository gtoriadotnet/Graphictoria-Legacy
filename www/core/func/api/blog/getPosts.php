<?php
	...
	foreach($stmt as $result) {
		...
		echo '<div class="well profileCard">
			<div class="row">
				<div class="col-xs-1"><div style="position: relative;border:solid 1px #158cba;height:50px;width:50px;height:50px;border-radius:50%;overflow: hidden;" class="img-circle"><img style="position: absolute" src="'.context::getUserHeadshotImage($userSheet).'" height="50"></div></div>
				<div class="col-xs-11">
