<?php
	...
	foreach($stmt as $result) {
		...
		if ($count < 10) {
			...
			echo '<b>'.htmlentities($username, ENT_QUOTES, "UTF-8").'</b></a></span><br><button value="'.$resultuser['id'].'" onclick="removeFriend('.$resultuser['id'].', '.$page.');" class="btn btn-danger btn-xs rmFr">Remove friend</button><br><br></div>';
		}
	}
	echo '</div>';
