	...
	<body>
		...
		<div class="container">
			<div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
				<div class="alert alert-warning">Outgoing emails to hotmail and outlook are currently paused. You may have to use gmail to receive the verification code.</div>
				<div id="vStatus"></div>
				...
				<p style="color:grey;text-align:center">If you need help, please contact <a href="mailto:support@gtoria.net">support@gtoria.net</a> and we will gladly help you</p>
			</div>
		</div>
