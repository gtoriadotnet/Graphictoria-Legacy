	...
	<body>
		...
		<div class="container">
			<?php
				...
				if($result['closed'] == 1) {
					echo '<center>This group has been locked.<br /><br />';
					...
					exit('</center><script src="/core/func/js/viewGroup.js"></script>');
				}
			...
			<div class="well profileCard">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-4">
						...
						<?php
							$stmt = $GLOBALS['dbcon']->prepare("SELECT thumbnailHash, headshotHash, id, username FROM users WHERE id = :id");
