				...
				<div class="well profileCard" style="margin-top:5px">
					<div class="row">
						<div class="col-xs-6">
							...
							<img class="img-responsive" src="<?php echo context::getItemThumbnailC($result['type'], $result['id'], $result['datafile'], $result['fileHash'], 0);?>">
						</div>
						<div class="col-xs-6">
							<h4>Details</h4>
							<?php if($GLOBALS['loggedIn'] && ($GLOBALS['userTable']['id'] == $result['creator_uid'] || $GLOBALS['userTable']['rank'] == 1)): ?>
								<a href="/catalog/configure/<?= $_GET['id']?>" style="position:absolute;top:0;right:15px" class="btn btn-primary"><i class="fa fa-cog" aria-hidden="true"></i></a>
							<?php endif; ?>
					...
					<?php
						if ($result['type'] == "decals") {
							...
							echo '<code style="word-wrap: break-word;white-space: pre-line;">http://gtoria.net/data/assets/uploads/'.$result['fileHash'].'</code><br>';
						}
					?>
					<b>Description</b><br>
					<?php
