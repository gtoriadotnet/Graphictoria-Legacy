...
<html>
	...
	<body>
		<script>
			function loadMoreItems(type, page, term) {
				$(".loadMore").remove();
				$.get("/core/func/api/catalog/getItems.php?type=" + type + "&page=" + page + (term ? "&term=" + term : ''), function(data) {
		...
		<div class="container">
			...
			<div class="col-xs-12 col-sm-12 col-md-10">
				<h3>Catalog</h3>
				<script src="/core/func/js/catalog.js?v=556"></script>
